    ...
    <div>
      ...
      <div className="relative z-20 bg-white dark:bg-form-input">
        ...
        >
          ...
          <option value="Muslim" className="text-body dark:text-bodydark">
            Muslim
          </option>
          <option value="Hindu" className="text-body dark:text-bodydark">
            Hindu
          </option>
          <option value="Christian" className="text-body dark:text-bodydark">
            Christian
          </option>
        </select>
